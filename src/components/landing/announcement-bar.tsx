...
export function AnnouncementBar() {
  return (
    <div className="w-full px-4 md:px-6 mb-4">
      <Link 
        href="/signup"
        className="group relative flex items-center justify-between mx-auto w-full max-w-[1360px] h-14 px-8 rounded-[20px] overflow-hidden transition-all border border-emerald-100/50"
      >
