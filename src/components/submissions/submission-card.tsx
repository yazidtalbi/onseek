      ...
      >
        <div className={cn("p-0 rounded-[20px] flex flex-col gap-1 h-full border border-gray-100", theme.bg)}>
          <div className="bg-white rounded-[16px] overflow-hidden flex flex-col h-full">
            <div className="flex flex-col flex-none p-4 sm:p-5 pb-0">
            ...
            <div className="flex flex-col flex-1 p-4 sm:p-5 pt-0 pb-0">
            ...
            <div className="mt-auto border-t border-gray-100">
              <div className="flex items-stretch">
                <div className="flex flex-col items-start flex-1 py-4 sm:py-5 px-4 sm:px-6 min-w-0">
