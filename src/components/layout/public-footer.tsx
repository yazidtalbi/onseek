...
export function PublicFooter() {
  ...
  return (
    <footer className="px-6 pb-6 pt-20">
      <div className="bg-[#222234] text-white pt-24 overflow-hidden rounded-[32px]">
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-8">
            ...
            <div className="space-y-6">
              <h4 className="font-bold text-white text-base" style={{ fontFamily: 'var(--font-expanded)', fontWeight: 700 }}>Explore</h4>
            ...
            <div className="space-y-6">
              <h4 className="font-bold text-white text-base" style={{ fontFamily: 'var(--font-expanded)', fontWeight: 700 }}>Compare</h4>
            ...
            <div className="space-y-6">
              <h4 className="font-bold text-white text-base" style={{ fontFamily: 'var(--font-expanded)', fontWeight: 700 }}>Legal</h4>
              <ul className="space-y-4">
                <li><Link href="/about" className="text-white hover:text-white/80 transition-colors text-sm font-semibold">About Us</Link></li>
                <li><Link href="/help" className="text-white hover:text-white/80 transition-colors text-sm font-semibold">Help Center</Link></li>
                <li><Link href="/trust" className="text-white hover:text-white/80 transition-colors text-sm font-semibold">Trust & Safety</Link></li>
                <li><Link href="/accessibility" className="text-white hover:text-white/80 transition-colors text-sm font-semibold">Accessibility</Link></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="w-full overflow-hidden select-none mt-8 text-center pb-12">
          <Link
            href="/"
        ...
        <div className="w-full px-8 py-10 flex flex-col md:flex-row items-center justify-between gap-8 bg-[#222234]">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
            ...
            <div className="flex items-center gap-6 order-1 md:order-2">
              <Link href="/privacy" className="text-[13px] font-semibold text-white hover:text-white/80 transition-colors">Privacy Policy</Link>
              <Link href="/terms" className="text-[13px] font-semibold text-white hover:text-white/80 transition-colors">Terms of Service</Link>
              <Link href="/cookies" className="text-[13px] font-semibold text-white hover:text-white/80 transition-colors">Cookie Settings</Link>
            </div>
          </div>
        </div>
      </div>
