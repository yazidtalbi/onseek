...
export const COMPETITORS: Record<string, CompetitorData> = {
  "facebook-marketplace": {
    ...
    conflictBody: [
      ...
      "Seller identity is often unclear. Photos are uploaded once and never updated. Prices are flexible: which really means 'I have no idea what this is worth.' Meanwhile you're stuck filtering through spam accounts and community groups with zero structure.",
      "The core problem: the burden of searching falls entirely on you. You scroll, you compare, you message, you get ghosted. Onseek flips this model completely.",
    ],
    tableRows: [
      { feature: "Buyer Intent", competitor: "'Is this available?'", onseek: "Request-First Flow" },
      { feature: "Ghosting Rate", competitor: "Extremely High", onseek: "Committed Buyers" },
      { feature: "In-app Messaging", competitor: true, onseek: true },
      { feature: "Feed Clutter", competitor: "Endless Ads", onseek: "Clean Marketplace" },
      { feature: "Privacy", competitor: "Tied to personal profile", onseek: "Professional Privacy" },
      { feature: "Notifications", competitor: "Lost in FB alerts", onseek: "Dedicated Dashboard" },
      { feature: "Large Active Community", competitor: true, onseek: true },
      { feature: "Mobile-Ready Platform", competitor: true, onseek: true },
    ],
    useCaseCards: [
      ...
      { icon: "👟", title: "Rare Sneakers", description: "Specify colorway, size, and condition. Get matched with specialists who actually have what you want." },
      ...
      { icon: "📱", title: "Unlocked Phones", description: "Define your carrier requirements and budget cap. Get competing offers from sellers within hours." },
    ],
    faqs: [
      { question: "How is Onseek safer than Facebook Marketplace?", answer: "Every seller on Onseek submits a structured proposal that includes product details, price, and shipping info. Unlike Facebook Marketplace where anyone can post anything, Onseek proposals are tied to clear profiles and rated by the community." },
  ...
  "etsy": {
    ...
    conflictBody: [
      ...
      "Custom orders on Etsy require back-and-forth messaging across 10 different sellers to get a quote. There's no standardised request format, no price comparison, and no clear path if a seller disappears mid-order. You're essentially doing project management for your own purchase.",
    ...
    tableRows: [
      { feature: "Listing Fees", competitor: "$0.20 per item", onseek: "Free" },
      { feature: "Transaction Cut", competitor: "~6.5% + fees", onseek: "0% Platform Fee" },
      { feature: "Niche Locked", competitor: "Vintage/Handmade only", onseek: "Anything you sell" },
      { feature: "Sell Anything", competitor: false, onseek: true },
      { feature: "Seller Autonomy", competitor: "Etsy owns customer", onseek: "You own the relationship" },
      { feature: "Handmade & Unique Items", competitor: true, onseek: true },
      { feature: "Global Creative Community", competitor: true, onseek: true },
    ],
    useCaseCards: [
      { icon: "💍", title: "Custom Jewellery", description: "Describe your stone, metal, and budget. Sellers submit proposals: no messaging 20 shops to get a quote." },
    ...
    faqs: [
      { question: "How is Onseek safer than Etsy?", answer: "Etsy disputes require seller cooperation and can take weeks to resolve. Onseek proposals are structured commitments. Every detail from materials to delivery timeline is locked before you accept, with community-rated profiles behind each seller." },
  ...
  "ebay": {
    ...
    accentColor: "#E53238",
    tagline: "No bids. No auctions. Just fixed-price offers",
    ...
    conflictBody: [
      "eBay's auction model is a 1995 solution to a 2026 problem. You monitor a listing for 7 days, get outbid with 3 seconds remaining, and start the whole process over. Meanwhile 'Buy It Now' prices are 30% above market because sellers know you're eager.",
      "The feedback system is outdated. Users with high ratings often have many unresolved disputes buried in the data. International shipping estimates are unreliable. Return policies are seller-dependent and routinely ignored.",
    ...
    tableRows: [
      { feature: "Pricing Model", competitor: "Stressful Bidding", onseek: "Fixed / Fair Request" },
      { feature: "No Bidding Wars", competitor: false, onseek: true },
      { feature: "Seller Fees", competitor: "Up to 13.25% + extra", onseek: "Zero Listing Fees" },
      { feature: "Search Results", competitor: "Pay-to-play results", onseek: "Fair Visibility" },
      { feature: "Shipping", competitor: "Global hurdles", onseek: "Streamlined Local/Ship" },
      { feature: "Support", competitor: "Bot-heavy resolution", onseek: "Human-centric Flow" },
      { feature: "Fixed-Price Proposals", competitor: true, onseek: true },
      { feature: "Global Marketplace", competitor: true, onseek: true },
    ],
    useCaseCards: [
      ...
      { icon: "⌚", title: "Luxury Watches", description: "Specify reference number, condition, and documentation. Only specialists with authentication knowledge respond." },
    ...
    faqs: [
      ...
      { question: "Does it cost more than eBay?", answer: "Onseek has no listing fees, final value fees, or transaction fees for buyers. The price you see in a proposal is the price you pay. Compare that to eBay's complex fee structure that often gets passed on to the buyer." },
      { question: "What about rare collectibles where I need bidding?", answer: "Onseek isn't an auction platform, but you can specify in your request that you're open to price options. Sellers can submit proposals within a range and you select the best offer: without the artificial auction deadline pressure." },
      { question: "Is shipping more reliable than eBay?", answer: "Proposals on Onseek include explicit shipping terms as part of the structured response. Sellers who misrepresent shipping timelines receive community feedback that affects their ranking, creating strong performance incentives." },
    ],
    metaDescription:
  ...
  "amazon": {
    ...
    conflictBody: [
      "Amazon has 350 million products. It also has millions of questionable listings and an algorithm that promotes paid placements over quality. Finding the right thing in a sea of sponsored results is a full-time job.",
      "The paradox of choice is real. You search for a standing desk, get 8,000 results, spend 2 hours reading feedback that may not be authentic, order something that looks different in person, and fight for a return. The 'convenience' of Amazon requires enormous buyer effort.",
    ...
    tableRows: [
      { feature: "Competition", competitor: "You vs. Amazon Basics", onseek: "You vs. Peers" },
      { feature: "Fees", competitor: "High commissions", onseek: "Keep 100% of price" },
      { feature: "Reviews", competitor: "Often manipulated", onseek: "Authentic Community" },
      { feature: "Setup Time", competitor: "Days of 'Approval'", onseek: "Minutes to Launch" },
      { feature: "Relationship", competitor: "You are a 'Vendor'", onseek: "You are a Founder" },
      { feature: "Vast Product Catalog", competitor: true, onseek: true },
      { feature: "Fast Shipping Options", competitor: true, onseek: true },
    ],
    useCaseCards: [
      { icon: "🏠", title: "Home Furniture", description: "Describe your dimensions, material, and style. Get proposals from specialist furniture dealers rather than generic Amazon listings." },
      ...
      { icon: "🧴", title: "Beauty & Skincare", description: "Specify ingredients, skin type, and country of origin. Get recommendations from beauty specialists." },
  ...
  "craigslist": {
    ...
    heroSubheadline:
      "Craigslist's anonymous classifieds created the wild west of online commerce. Onseek builds structured accountability in every interaction: so you never have to meet a stranger in a parking lot.",
    conflictBody: [
      "Craigslist has barely changed since 1996. Anonymous posts, lack of seller identity, cash-in-person transactions, and a high risk that requires every buyer to be extra cautious. 'Too good to be true' isn't a warning on Craigslist: it's Tuesday.",
      ...
      "Craigslist optimizes for the seller's convenience. Onseek optimizes for the buyer's outcome. The difference is a structured proposal system where transparency is built into every interaction.",
    ],
    tableRows: [
      { feature: "User Profiles", competitor: "Anonymous / None", onseek: "Detailed & Rated" },
      { feature: "Communication", competitor: "Shady email relays", onseek: "Clean In-app Chat" },
      { feature: "Interface", competitor: "1995 Text-only", onseek: "SaaS-Premium UI" },
      { feature: "Mobile Optimized Design", competitor: false, onseek: true },
      { feature: "Search Logic", competitor: "Keyword spamming", onseek: "High-Intent Requests" },
      { feature: "Safety", competitor: "High-risk meetups", onseek: "Secure Infrastructure" },
      { feature: "Large Local Presence", competitor: true, onseek: true },
      { feature: "Free for Buyers", competitor: true, onseek: true },
    ],
    useCaseCards: [
      ...
      { icon: "📦", title: "Moving Services", description: "Post your move details and date. Get competing quotes from movers with community ratings and insurance documentation." },
      { icon: "🏠", title: "Rentals & Housing", description: "Define your requirements, location, and budget. Receive proposals from landlords with transparent terms." },
    ],
    faqs: [
      { question: "How is Onseek safer than Craigslist?", answer: "Craigslist has zero seller identity check. Onseek requires sellers to create community profiles before submitting proposals. Every proposal includes structured product information that can't be fabricated anonymously." },
      { question: "Can I find the same items as on Craigslist?", answer: "Yes, and with significantly less risk. Our community includes the same local sellers and service providers who post on Craigslist, but within a structured system that holds them to their commitments." },
      { question: "Does it cost more than Craigslist?", answer: "Craigslist is free for buyers but 'free' doesn't account for the time and risk cost. Onseek is also free for buyers, but adds the layer of transparency that makes the transaction safe and predictable." },
      { question: "What about local deals and pickup?", answer: "You can specify 'local pickup' as a requirement in your Onseek request. Proposals will come from sellers in your area who can accommodate in-person exchange: with the safety of a profile behind the transaction." },
