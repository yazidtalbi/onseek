...
const defaultContent = {
  title: "Onseek Foundation",
  content: `The Onseek Foundation is our commitment to giving back to the community. We support initiatives that help people access the products they need.
...
export default async function FoundationPage() {
  ...
  try {
    const cmsContent = await getPageBySlug("foundation");
